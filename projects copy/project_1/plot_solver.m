...
figure(1)
plot(xx , yy , 'r' , x , u , 'b','LineWidth',2)
...
% doc = {'error_10.txt';'error_100.txt';'error_1000.txt';'error_10000.txt';'error_100000.txt';'error_1000000.txt'};

B = load('time_lu_10.txt');
y = B(:,1);
y = [0;y;0];
figure(3)
...
% end
% figure(2)
% plot(h,relMaxError,'r','LineWidth',2)
